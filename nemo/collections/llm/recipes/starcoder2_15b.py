...
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Starcoder2 15B model configuration.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Starcoder2 15b model.

    Examples:
        CLI usage:
            $ nemo llm pretrain model=starcoder2_15b ...
...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for Starcoder2 15B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory starcoder2_15b
            $ nemo llm pretrain --factory "starcoder2_15b(num_nodes=1, name='my_starcoder2_pretrain')"
...
def finetune_recipe(
    ...
    Examples:
        CLI usage:
            $ nemo llm finetune --factory starcoder2_15b

        Python API usage:
            >>> recipe = finetune_recipe(name="starcoder2_15b_finetune", num_nodes=2)
            >>> print(recipe)
