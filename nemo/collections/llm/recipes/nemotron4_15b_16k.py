...
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Nemotron4 15b model with 16k sequence length.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Nemotron4 15b and 16k sequence length model.
...
def pretrain_recipe(
    ...
    Examples:
        CLI usage:
            ...
            $ nemo llm pretrain --factory "nemotron4_15b_16k(num_nodes=1, name='my_nemotron_pretrain')"
