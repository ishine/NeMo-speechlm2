...
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Qwen2 500m model configuration.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Qwen2 500m model.

    Examples:
        CLI usage:
            $ nemo llm pretrain model=qwen2_500m ...
...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for Qwen2 500m model.
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory qwen2_500m
            $ nemo llm pretrain --factory "qwen2_500m(num_nodes=1, name='my_qwen2_pretrain')"
...
def finetune_recipe(
    ...
    Examples:
        ...
        Python API usage:
            >>> recipe = finetune_recipe(name="qwen2_500m_finetune", num_nodes=2)
            >>> print(recipe)
