...
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Qwen3 4B model configuration.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Qwen3 4B model.

    Examples:
        CLI usage:
            $ nemo llm pretrain model=qwen3_4b ...
...
def pretrain_recipe(
    ...
    name: str = "default",
    # Trainer
    tensor_parallelism: int = 2,  # Default increased for 4B model
    ...
    """
    Create a pre-training recipe for Qwen3 4B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory qwen3_4b
            $ nemo llm pretrain --factory "qwen3_4b(num_nodes=1, name='my_qwen3_pretrain')"
...
def finetune_recipe(
    ...
    """
    Create a fine-tuning recipe for Qwen3 4B model.
    ...
    Examples:
        CLI usage:
            $ nemo llm finetune --factory qwen3_4b

        Python API usage:
            >>> recipe = finetune_recipe(name="qwen3_4b_finetune", num_nodes=2)
            >>> print(recipe)
    ...
    recipe = default_finetune_recipe(
        model(), "Qwen/Qwen3-4B", dir, name, num_nodes, num_gpus_per_node, packed_sequence
    )
