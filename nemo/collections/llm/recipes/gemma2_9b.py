...
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Gemma2 9B model configuration.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Gemma2 9B model.
...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for gemma2 9B model.
    ...
    Examples:
        CLI usage:
            ...
            $ nemo llm pretrain --factory "gemma2_9b(num_nodes=1, name='my_gemma2_pretrain')"
...
def finetune_recipe(
    ...
    Examples:
        CLI usage:
            $ nemo llm finetune --factory gemma2_9b

        Python API usage:
            >>> recipe = finetune_recipe(name="gemma2_9b_finetune", num_nodes=2)
            >>> print(recipe)
