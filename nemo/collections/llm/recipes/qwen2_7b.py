...
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Qwen2 7b model configuration.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Qwen2 7b model.

    Examples:
        CLI usage:
            $ nemo llm pretrain model=qwen2_7b ...
...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for Qwen2 7b model.
    ...
    Examples:
        CLI usage:
            $ nemo llm pretrain --factory qwen2_7b
            $ nemo llm pretrain --factory "qwen2_7b(num_nodes=1, name='my_qwen2_pretrain')"
...
def finetune_recipe(
    ...
    Examples:
        CLI usage:
            $ nemo llm finetune --factory qwen2_7b

        Python API usage:
            >>> recipe = finetune_recipe(name="qwen2_7b_finetune", num_nodes=2)
            >>> print(recipe)
