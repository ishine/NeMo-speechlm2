...
def model() -> run.Config[pl.LightningModule]:
    """
    Factory function to create a Nemotron3 4B model configuration.

    Returns:
        run.Config[pl.LightningModule]: Configuration for the Nemotron3 4B model.

    Examples:
        CLI usage:
            $ nemo llm pretrain model=nemotron ...
...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for Nemotron3 4B model.
