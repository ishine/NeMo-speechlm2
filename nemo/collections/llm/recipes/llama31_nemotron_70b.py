...
def model() -> run.Config[pl.LightningModule]:
    ...
    Examples:
        ...
        Python API usage:
            ...
            >>> print(model_config)
    """
    conf = run.Config(Llama31Nemotron70BConfig)
...
def finetune_recipe(
    ...
    if model_type.lower() == 'instruct':
        resume_path = 'nvidia/Llama-3.1-Nemotron-70B-Instruct-HF'
    elif model_type.lower() == 'reward':
        resume_path = 'nvidia/Llama-3.1-Nemotron-70B-Reward-HF'
    else:
        raise ValueError(f'Unknown model_type {model_type}. Expected one of "instruct" or "reward".')
