...
def pretrain_recipe(
    ...
    """
    Create a pre-training recipe for Qwen2.5 72b model.
...
def finetune_recipe(
    ...
    """
    Create a fine-tuning recipe for Qwen2.5 72b model.
    ...
    Examples:
        ...
        Python API usage:
            >>> recipe = finetune_recipe(name="qwen25_72b_finetune", num_nodes=2)
            >>> print(recipe)
    ...
    recipe = default_finetune_recipe(
        model(), "Qwen/Qwen2.5-72B", dir, name, num_nodes, num_gpus_per_node, packed_sequence
    )
