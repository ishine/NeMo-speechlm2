...
from nemo.collections.common.prompts import Llama2PromptFormatter, CanaryQwenPromptFormatter
...
@registered_prompt_format_fn(NeMoMultimodalConversation, CanaryQwenPromptFormatter)
def canary_qwen_multimodal_conversation_prompt_format_fn(
    example: NeMoMultimodalConversation, prompt: CanaryQwenPromptFormatter
):
    # Collapse consecutive same-role turns into single turn for proper prompt formatting.
    turns = groupby(
        [
